...
import { Sparkles, Home, MessageCircle, User } from "lucide-react";
              ...
              <div className="flex items-center gap-3 ml-2">
                ...
                <SignedIn>
                  <div className="flex items-center gap-3">
                    ...
                    {/* <div className="bg-white/10 backdrop-blur border border-white/20 rounded-xl overflow-hidden hover:bg-white/20 transition-all duration-300">
                      <UserButton />
                    </div> */}
                    <UserButton />
                  </div>
